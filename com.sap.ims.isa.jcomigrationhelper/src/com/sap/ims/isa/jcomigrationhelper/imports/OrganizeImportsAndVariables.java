...
public class OrganizeImportsAndVariables implements IEditorActionDelegate, IObjectActionDelegate {

    public OrganizeImportsAndVariables() {
        super();
    }
    ...
    public void run(IAction action) {
        ...
        if (selection != null) {
            try {
                ...
                progressMonitorDialog.run(true, true, new ImportOrganizerTask(selection));
            } catch (InvocationTargetException e) {
                JCoMigrationHelperPlugin.logErrorMessage(Messages.imports_gen_error_in_task, e);
                MessageDialog.openError(JCoMigrationHelperPlugin.getActiveWorkbenchShell(),
                        Messages.imports_gen_info_not_generated_title, Messages.imports_gen_error_in_task);
            ...
            MessageDialog.openInformation(JCoMigrationHelperPlugin.getActiveWorkbenchShell(),
                    Messages.imports_gen_info_not_generated_title,
                    Messages.imports_gen_info_not_generated_type_not_supported);
        }
    }
